...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        with open("data/cross_ref.rou.xml", "w") as routes:
            print("""<routes>
            <vType accel="1.0" decel="4.5" id="standard_car" length="5.0" minGap="2.5" maxSpeed="25" sigma="0.5" />
            <route id="W_N" edges="Wi No"/>
            <route id="W_E" edges="Wi Eo"/>
            <route id="W_S" edges="Wi So"/>
            <route id="N_W" edges="Ni Wo"/>
            <route id="N_E" edges="Ni Eo"/>
            <route id="N_S" edges="Ni So"/>
            <route id="E_W" edges="Ei Wo"/>
            <route id="E_N" edges="Ei No"/>
            <route id="E_S" edges="Ei So"/>
            <route id="S_W" edges="Si Wo"/>
            <route id="S_N" edges="Si No"/>
            <route id="S_E" edges="Si Eo"/>""", file=routes)
...
if __name__ == '__main__':
    traffic_generator = TrafficGenerator(5400)
    traffic_generator.generate_routefile(32)